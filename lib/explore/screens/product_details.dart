...
class _CommentSectionState extends State<CommentSection> {
  ...
  void _fetchComments() {
    ...
    _commentService.fetchComments(widget.productId).then((response) {
      setState(() {
        _currentUser = response['current_user'];
      });
    }).catchError((_) {
      setState(() {
  ...
  void _handleAddComment() {
    if (_currentUser == null) {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (_) => const LoginPage()), // Navigasi ke halaman login
      );
      return;
    }
